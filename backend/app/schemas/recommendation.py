...
class RecommendationRequest(BaseModel):
    ...
    # Yarıçap üst sınırını 20.0 km'ye çıkar
    radius_km: float = Field(default=5.0, ge=0.5, le=20.0, description="Arama yarıçapı (km)")
    ...
    top_k: int = Field(default=10, ge=3, le=20, description="Döndürülecek sonuç sayısı")
